...
- [ ] Testar seção ADMIN: `/fiscal/parametros`, `/admin/configuracoes` e `/vinculos` só acessíveis a usuários com `profiles.role = 'admin'` (redireciona para `/intranet` caso contrário); `/admin/bloqueio` retorna 404
