...
import type { TarefaFinanceiroAplicavel } from '@/app/financeiro/clientes/tarefas-actions'

interface Props {
  tarefas: TarefaFinanceiroAplicavel[]
  etapas: TarefaEtapa[]
  podeEditar: boolean
...
export default function TarefasFinanceiroChecklist({
